...
As shown by the above plot of resampled RMSE, the xgBoost method with the expanded set of features had the best results by a considerable margin. This makes sense considering Dr. Yurko's positive comments regarding xgBoost from the beginning of the semester!
